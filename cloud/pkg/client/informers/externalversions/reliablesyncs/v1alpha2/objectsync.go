...
type ObjectSyncInformer interface {
	...
	Lister() v1alpha2.ObjectSyncLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ReliablesyncsV1alpha2().ObjectSyncs(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ReliablesyncsV1alpha2().ObjectSyncs(namespace).Watch(options)
			},
		},
		&reliablesyncsv1alpha2.ObjectSync{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *objectSyncInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&reliablesyncsv1alpha2.ObjectSync{}, f.defaultInformer)
}

func (f *objectSyncInformer) Lister() v1alpha2.ObjectSyncLister {
	return v1alpha2.NewObjectSyncLister(f.Informer().GetIndexer())
}
