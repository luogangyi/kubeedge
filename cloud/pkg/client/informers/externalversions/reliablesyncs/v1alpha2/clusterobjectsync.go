...
import (
	...
	v1alpha2 "github.com/kubeedge/kubeedge/cloud/pkg/client/listers/reliablesyncs/v1alpha2"
...
type ClusterObjectSyncInformer interface {
	...
	Lister() v1alpha2.ClusterObjectSyncLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ReliablesyncsV1alpha2().ClusterObjectSyncs().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ReliablesyncsV1alpha2().ClusterObjectSyncs().Watch(options)
			},
		},
		&reliablesyncsv1alpha2.ClusterObjectSync{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterObjectSyncInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&reliablesyncsv1alpha2.ClusterObjectSync{}, f.defaultInformer)
}

func (f *clusterObjectSyncInformer) Lister() v1alpha2.ClusterObjectSyncLister {
	return v1alpha2.NewClusterObjectSyncLister(f.Informer().GetIndexer())
}
