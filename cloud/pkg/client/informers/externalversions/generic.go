...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha2.SchemeGroupVersion.WithResource("devicemodels"):
		...
		// Group=reliablesyncs.kubeedge.io, Version=v1alpha2
	case reliablesyncsv1alpha2.SchemeGroupVersion.WithResource("clusterobjectsyncs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Reliablesyncs().V1alpha2().ClusterObjectSyncs().Informer()}, nil
	case reliablesyncsv1alpha2.SchemeGroupVersion.WithResource("objectsyncs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Reliablesyncs().V1alpha2().ObjectSyncs().Informer()}, nil
