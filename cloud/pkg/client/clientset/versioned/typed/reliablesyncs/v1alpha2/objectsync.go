...
type ObjectSyncInterface interface {
	Create(*v1alpha2.ObjectSync) (*v1alpha2.ObjectSync, error)
	Update(*v1alpha2.ObjectSync) (*v1alpha2.ObjectSync, error)
	UpdateStatus(*v1alpha2.ObjectSync) (*v1alpha2.ObjectSync, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha2.ObjectSync, error)
	List(opts v1.ListOptions) (*v1alpha2.ObjectSyncList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.ObjectSync, err error)
	ObjectSyncExpansion
}
...
func newObjectSyncs(c *ReliablesyncsV1alpha2Client, namespace string) *objectSyncs {
	return &objectSyncs{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *objectSyncs) Get(name string, options v1.GetOptions) (result *v1alpha2.ObjectSync, err error) {
	result = &v1alpha2.ObjectSync{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *objectSyncs) List(opts v1.ListOptions) (result *v1alpha2.ObjectSyncList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.ObjectSyncList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("objectsyncs").
...
func (c *objectSyncs) Create(objectSync *v1alpha2.ObjectSync) (result *v1alpha2.ObjectSync, err error) {
	result = &v1alpha2.ObjectSync{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("objectsyncs").
...
func (c *objectSyncs) Update(objectSync *v1alpha2.ObjectSync) (result *v1alpha2.ObjectSync, err error) {
	result = &v1alpha2.ObjectSync{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("objectsyncs").
...
func (c *objectSyncs) UpdateStatus(objectSync *v1alpha2.ObjectSync) (result *v1alpha2.ObjectSync, err error) {
	result = &v1alpha2.ObjectSync{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("objectsyncs").
...
func (c *objectSyncs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.ObjectSync, err error) {
	result = &v1alpha2.ObjectSync{}
