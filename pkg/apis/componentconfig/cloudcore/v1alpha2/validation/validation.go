...
func ValidateCloudCoreConfiguration(c *v1alpha2.CloudCoreConfig) field.ErrorList {
...
func ValidateModuleCloudHub(c v1alpha2.CloudHub) field.ErrorList {
	if !c.Enable {
		return field.ErrorList{}
	}
...
func ValidateModuleEdgeController(e v1alpha2.EdgeController) field.ErrorList {
	if !e.Enable {
		return field.ErrorList{}
	}
	allErrs := field.ErrorList{}
...
func ValidateModuleDeviceController(d v1alpha2.DeviceController) field.ErrorList {
	if !d.Enable {
		return field.ErrorList{}
	}
...
func ValidateModuleSyncController(d v1alpha2.SyncController) field.ErrorList {
	if !d.Enable {
		return field.ErrorList{}
	}
...
func ValidateModuleCloudStream(d v1alpha2.CloudStream) field.ErrorList {
	if !d.Enable {
		return field.ErrorList{}
	}
...
func ValidateKubeAPIConfig(k v1alpha2.KubeAPIConfig) field.ErrorList {
	allErrs := field.ErrorList{}
